...
public class RegistrationFormTests extends TestBase {
    ...
    void allFieldsPopulatedTest() {
        ...
        $("#hobbiesWrapper").$$("label")
                ...
                .click();
        $("#uploadPicture")
                .uploadFromClasspath("images/scottish_cat.png");
        $("#uploadPicture")
                .shouldHave(value("cat.png"));
        $("#currentAddress").setValue("1st street");
        $("#state").click();
        $$("[id^=react-select-3-option]")
                .findBy(text("Uttar Pradesh"))
                .click();
        $("[id=city]").click();
        ...
        $(".table-responsive")
                .$(byText("Student Name"))
                .closest("tr")
                .shouldHave(text("Test Name Test Last Name"));
        $(".table-responsive")
        ...
        $(".table-responsive")
                ...
                .closest("tr")
                .shouldHave(text("01 October,1995"));
        $(".table-responsive")
                .$(byText("Subjects"))
                .closest("tr")
        ...
        $(".table-responsive")
                .$(byText("Picture"))
                .closest("tr")
                .shouldHave(text("scottish_cat.png"));
        $(".table-responsive")
                .$(byText("Address"))
                .closest("tr")
                .shouldHave(text("1st street"));
        $(".table-responsive")
